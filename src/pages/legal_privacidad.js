          ...
          <div className="row">
            <div className="col-xs-12">
              <div className="p1  p-content">
                ...
                el párrafo anterior, se le informa de que: a|| En cumplimiento
                de lo establecido en la Ley Orgánica de Protección de Datos de
                ...
                puede ver más abajo la política de cookies||. c- En la recogida
                y el tratamiento de los datos de carácter personal se han
                ...
                1720/2007, de 21 de diciembre. d- El compromiso por parte del
                titular de proteger la información confidencial a la que tenga
                acceso. e- El titular se compromete a que, estos datos
                ...
                la información aquí: https://www.privacyshield.gov/list||. f- En
                caso de facilitarnos datos de carácter personal de otras
                ...
                persona que cede dichos datos al titular. g- En caso de no
                facilitar los datos requeridos, los servicios de la página web
                ...
                funcionalidades de la página web. h- El consentimiento expreso
                ...
                competentes o por mandato judicial. i- El Usuario certifica que
                es mayor de 14 años y que por lo tanto posee la capacidad legal
                ...
                Privacidad. j- El Usuario cuenta, en todo momento, con la
                ...
                de correo electrónico ruben.manez.leal@gmail.com o a través de
                los enlaces dispuestos a tal efecto en las notificaciones
                electrónicas. k- El interesado tiene derecho a recibir los datos
                ...
                responsable del tratamiento al que haya facilitado los datos. l-
                ...
                reclamaciones. m- El usuario tiene derecho a retirar el
                consentimiento prestado. n- El usuario tiene derecho a reclamar
                ante la Autoridad de Control. o- El Usuario autoriza al
