        ...
        <div className="container-3">
          ...
          <div className="row">
            <div className="col-xs-12">
              ...
              general, la relación entre el website y los usuarios del mismo (en
              adelante, los “usuarios”). Se entenderá que el acceso y
              ...
              modificación. En consecuencia, será necesaria su lectura por parte
              ...
              está destinado a promocionar la actividad profesional de su
              titular. La adquisición de los servicios o productos realizadas a
              través del website quedan expresamente sujetas a las condiciones
              particulares de adquisición de dichos servicios o productos,
              establecidos al efecto y sin perjuicio de lo dispuesto en las
              presentes Condiciones Generales. <br /> <br />
              <h5 className="h3 mb-20">Normas de uso de la web</h5> El website
              distribuye contenidos (textos, gráficos, dibujos, diseños,
              códigos, software, fotografías, música, vídeos, sonidos, bases de
              ...
              suscitarse respecto a los mismos. En todo caso, el prestador
              cuenta con la autorización expresa y previa por parte de los
              mismos. Para realizar cualquier tipo de observación respecto a
              ...
              pruebas que permitan valorar que cumplen con un adecuado nivel de
              calidad. El prestador se compromete a no incluir enlaces de
              afiliados arbitrarios a productos que no cumplan con las
              condiciones antes descritas entendiendo además que este tipo de
              prácticas resultarían muy contraproducentes para la reputación del
              propio sitio web que los promociona. En estos casos, el titular no
              será responsable de establecer las condiciones generales y
              particulares de uso a tener en cuenta en la utilización,
              prestación o contratación de estos servicios por terceros y, por
              tanto, no podrá ser considerado responsable de los mismos. La
              utilización y/o la contratación de dichos servicios específicos
              implica la aceptación de las condiciones particulares que los
              regulen en la versión publicada por el website en el momento en
              ...
              considere oportunas en el portal y en el aviso legal, pudiendo
              ...
              Condiciones Generales de Uso. <br /> <br />
              <h5 className="h3 mb-20">Ley Aplicable y Jurisdicción</h5> Para la
              resolución de todas las controversias o cuestiones relacionadas
              con el presente sitio web o de las actividades en él
